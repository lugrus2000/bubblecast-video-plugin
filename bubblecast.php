<?php
/*
Plugin Name: bubblecast
Plugin URI: http://wordpress.org/bubblecast
...
function embed_quickcast($content){
    ...
    if (!$siteId && bubblecast_is_admin()) {
        $ep .= ('<div align="center" style="color: red;">You haven\'t set up Bubblecast login and password. Please, follow installation instructions to finish setup in your administration console</div>');
    }

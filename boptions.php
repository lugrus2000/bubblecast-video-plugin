...
<td>
    <select name="bubblecast_language" value="<?php echo get_option('bubblecast_language'); ?>">
        <option value="en"<?php if (get_bubblecast_option('bubblecast_language') == 'en') { ?> selected="selected"<?php } ?>><?php _e('English') ?></option>
        <option value="ru"<?php if (get_bubblecast_option('bubblecast_language') == 'ru') { ?> selected="selected"<?php } ?>><?php _e('Russian') ?></option>
    </select>
</td>
</tr>
<tr>
